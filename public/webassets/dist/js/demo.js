...
(function($) {
    ...
    $container.append(
        '<h5>تخصيص الداشبورد</h5><hr class="mb-2"/>'
    )
    ...
    var $dark_mode_container = $('<div />', { class: 'mb-4' }).append($dark_mode_checkbox).append('<span>الوضع الليلي</span>')
...
function initHijrDatePicker() {
    $(".hijri-date-default-test").hijriDatePicker({

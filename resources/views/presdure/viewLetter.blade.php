        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <textarea  name="text" readonly class="form-control " rows="5">{{$letter->text}}</textarea>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" readonly value="{{$letter->letter_no}}" name="letter_no" class="form-control" id="">
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <label>ملاحظات </label>
                    <textarea readonly name="notes" class="form-control" rows="5">{{$letter->notes}}</textarea>
                </div>
            </div>
        </div>
    </div>

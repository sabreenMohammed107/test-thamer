...
<body>
  ...
  ">
        ...
        <div class="main" style="margin: 0com 1cm" >
            ...
            <p style="text-align: center">عقد {{$row->type->type ?? ''}} </p>

            {{-- param --}}
            <p style="text-align: right"><span style="border-bottom: 2px solid #000;
                "> :تمهيد </span></p>
            {{-- param --}}
            <p style="text-align: right;">{!! $row->intro !!}</p>
            <p style="text-align: right;">  <span>{{$row->firstSide->name ?? ''}} : الطرف الاول </span></p>
                <p style="text-align: right"><span style="
                    ">{{$row->firstSide->identity_no ?? ''}} : رقم الهويه </span> </p>

                <p style="text-align: right"><span style="
                    "> :موبايل  </span> {{$row->firstSide->mobile ?? ''}}</p>

<hr>
<p style="text-align: right;"> <span>الطرف الثانى  :</span> {{$row->secondSide->name ?? ''}}</p>
<p style="text-align: right"><span > :رقم الهويه </span> {{$row->secondSide->identity_no ?? ''}}</p>

<p style="text-align: right"><span style="
    "> :موبايل  </span> {{$row->secondSide->mobile ?? ''}}</p>
    <hr>
...
<p style="text-align: right"><span style="border-bottom: 2px solid #000;
    "> :البنود </span></p>
{{-- param --}}
<p style="text-align: right;">{!! $row->contract_items !!}</p>

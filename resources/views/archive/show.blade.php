                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->file_no }}"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="custom-select" id="court_id" name="court_id">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->circle_no }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->exec_dision_no }}"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->exec_Deed_no }}"
                                                                name="exec_dision_no" class="form-control" id="">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="">تاريخ سند التنفيذ </label>
                                                            <input type="text" autocomplete="off" value="" name="start_date"
                                                                class="form-control txt-rtl hijri-date-default" id=""
                                                                placeholder="{{ date('Y/m/d', strtotime($row->exec_Deed_date)) }}">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="custom-select dynamic" name="branch_id"
                                                                id="branch_id">
                                                                <option>اختر </option>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->court_row_no }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->client_low_description }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                    ...
                                                    @hasrole('Admin')
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select" id="fees_type" name="fees_type">
                                                                    <option {{ $row->fees_type == 0 ? 'selected' : '' }}
                                                                        value="0">كاش</option>
                                                                    <option {{ $row->fees_type == 1 ? 'selected' : '' }}
                                                                        value="1"> قسط</option>
                                                    ...
                                                    @hasrole('Admin')
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ $row->row_fees }}" readonly
                                                                    name="row_fees" class="form-control" id="">
                                                            </div>
                                                        </div>
                                                    @endhasrole
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->client->name ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->client->mobile ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->client->email ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->client->fax ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->client->phone ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->client->job ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->client->address ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $row->oppon->name ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="">العنوان</label>
                                                            <input type="text" value="{{ $row->oppon->address ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="">رقم الجوال</label>
                                                            <input type="text" value="{{ $row->oppon->mobile ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="">البريد الالكتروني</label>
                                                            <input type="text" value="{{ $row->oppon->email ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="">هاتف</label>
                                                            <input type="text" value="{{ $row->oppon->phone ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="">فاكس</label>
                                                            <input type="text" value="{{ $row->oppon->fax ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="">الوظيفة</label>
                                                            <input type="text" value="{{ $row->oppon->job ?? '' }}"
                                                                class="form-control" id="" disabled>
                                                        </div>
                                                    </div>

...
<th>الحالة</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <th>
                <div class="btn-group">
                    <button type="button"  @if($task->task_status_id==1) disabled @endif class="btn btn-default" data-toggle="modal" data-target="#done3{{ $row->id }}"><i class="fas fa-check" title="view"></i></button>
                </div>
            </th>
            <th>
                <div class="btn-group">

...
<th>الحالة</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <th>
                <div class="btn-group">
                    <button type="button"  @if($task && $task->task_status_id==1) disabled @endif class="btn btn-default" data-toggle="modal" data-target="#done3{{ $row->id }}"><i class="fas fa-check" title="view"></i></button>
                </div>
            </th>
            <th>
                <div class="btn-group">
                    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#view-tab3{{$row->id}}"><i class="fas fa-eye" title="view"></i></button>
                    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#edit-tab3{{$row->id}}"><i class="fas fa-edit" title="edit"></i></button>
...
<div class="modal fade dir-rtl" id="del{{ $row->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        ...
        <!-- Edit Tab-3 Modal -->
<div class="modal fade dir-rtl" id="edit-tab3{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
            ...
            <div class="modal-body text-center">
                ...
                <form role="form" action="{{ route('regulation.update',$row->id) }}"
                    method="post">
                    @method('PUT')
                    @csrf
                    <input type="hidden" name="case_id" value="{{$case->id}}">
...
<!-- View Tab-3 Modal -->
<div class="modal fade dir-rtl" id="view-tab3{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
   ...
   <!-- Add Tab-3 Modal -->
   <div class="modal fade dir-rtl" id="add-tab3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">

                      ...
                      <div class="invoice p-3 mb-3">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-5 invoice-col text-left invoice-footer bg-dark">
                                <strong><span class="pdf-footer">    الرياض : t.s.a.lawyer@gmail.com   -- 055 33 8 40 48</span></strong><br>
                                <strong><span class="pdf-footer">    حفر الباطن : t.s.a.lawyer@gmail.com   -- 055 0 66 80 95</span></strong><br>
                            </div>
                            <!-- /.col -->
                          </div>
                      </div>

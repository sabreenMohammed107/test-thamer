                            ...
                            @if (isset($regulation))
                                ...
                                <button type="button" class="btn btn-default" data-toggle="modal"
                                    data-target="#view-tab20{{ $regulation->id }}"><i class="fas fa-eye"
                                        ...
                                        <a href="{{route('regulationReport', $regulation->id) }}" target="_blank" class="btn btn-default"><i class="fas fa-print" title="print"></i></a>
                            ...
                            @if (isset($letter))
                                <button type="button" class="btn btn-default" data-toggle="modal"
                                    data-target="#view-tab20{{ $letter->id }}"><i class="fas fa-edit"
                                        title="view"></i></button>
                                <button type="button" class="btn btn-default" data-toggle="modal"
                                    data-target="#view-tab20{{ $letter->id }}"><i class="fas fa-eye"
                                        title="view"></i></button>
                                <!-- View Tab-5 Modal -->
                                <div class="modal fade dir-rtl" id="view-tab20{{ $letter->id }}" tabindex="-1"
                                    role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header bg-light">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" value=""
                                        ...
                                        class="form-control" id="" placeholder="{{date('d-m-Y', strtotime(Carbon\Carbon::now())) }}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">

                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                <i class="fas fa-edit"></i> تعديل قضية
                                <?php
                                $case = 0;
                                            ...
                                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                                <div class="tab-pane fade show active" id="custom-tabs-one-1"
                                                    ...
                                                    <div class="card card-primary">
                                                        <!-- form start -->
                                                        <form role="form" action="{{ route('cases.update',$row->id) }}"
                                                            method="post">
                                                            @method('PUT')
                                                            @csrf
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text"
                                                                                value="{{ $row->police_escalation_no }}"
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for="">رقم القضيه في النيابة
                                                                                العامة</label>
                                                                            <input type="text"
                                                                                value="{{ $row->public_prosecutor_case_no }}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control select2"
                                                                            ...
                                                                            @foreach ($clients as $type)
                                                                                <option
                                                                                    {{ $row->client_id == $type->id ? 'selected' : '' }}
                                                                                    value="{{ $type->id }}">
                                                                                    {{ $type->name }} /
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control select2"
                                                                            ...
                                                                            @foreach ($oppenonts as $type)
                                                                                <option
                                                                                    {{ $row->opponent_id == $type->id ? 'selected' : '' }}
                                                                                    value="{{ $type->id }}">
                                                                                    {{ $type->name }} /
                                                                                    {{ $type->identity_no }}</option>
                                                                            @endforeach

...
<body >
    ...
    <div id="mastercontainer" class="body" >
        ...
        <div class="main" style="margin: 0com 1cm">
            ...
            <p style="text-align: right;">{{$petition->title}}   /
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
            ...
            <p style="text-align: right;"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <p style="text-align: right"><span style="border-bottom: 2px solid #000;
                    "> :نص الإلتماس </span></p>
            {{-- param --}}
            <p style="text-align: right;">{{ $petition->text }}</p>
            ...
            {{-- param --}}
            <p style="text-align: left;font-weight: bold;padding:0;margin:0">{{ $petition->member->name ?? '' }}</p>
        </div>
</body>
